...
class PlantingScheduleController extends Controller
{
    ...
    public function store(PlantingScheduleStoreRequest $request)
    {
        ...
        return  redirect()->route('planting-schedule.show',  $plantingSchedule->id)->with('info', 'Berhasil Membuat Penjadwalan Baru');
    }

    public function destroy($id)
    {
        PlantingSchedule::findOrFail($id)->delete();
        return redirect()->route('planting-schedule.index')->with('info', 'Penjadwalan Berhasil Dihapus');
    }
}
